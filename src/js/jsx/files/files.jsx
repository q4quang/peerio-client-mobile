(function () {
  ...
  Peerio.UI.Files = React.createClass({
    ...
    render: function () {
      ...
      var uploadNodes;
      if (Peerio.Files.uploads.length > 0) {
        uploadNodes = [];
          ...
          uploadNodes.push(
            <div className="list-item">
              ...
              <div className="list-item-content">
                <div
                  className="list-item-title"><i className="fa fa-circle-o-notch fa-spin"></i> {u.stateName} {u.totalChunks ? u.currentChunk + ' of ' + u.totalChunks : ''}</div>
                <div className="list-item-description">{u.fileName}</div>
              </div>
            </div>);
        });
      }
      ...
      var content =
        (Peerio.Files.cache && Peerio.Files.cache.length == 0) ?
