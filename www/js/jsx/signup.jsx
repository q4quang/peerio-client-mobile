(function () {
  ...
  Peerio.UI.Signup = React.createClass({
    ...
    doSignup: function () {
     this.setState({activeStep:3});
      Peerio.Auth.signup(this.state.username, this.state.passphrase, this.state.firstName, this.state.lastName)
        .then(function () {
          Peerio.Auth.login(this.state.username, this.state.passphrase)
            .then(function () {
    ...
    renderSpinner: function(){
     return  <fieldset><i className="fa fa-circle-o-notch fa-spin" style={{ marginLeft: '45%',fontSize: '400%',marginTop: '50%'}}></i></fieldset>;
    },
    renderSMS: function () {
      return (<div>
        ...
        <Peerio.UI.Tappable className="btn-md btn-safe" onTap={this.handleSMSCode}> Send SMS code</Peerio.UI.Tappable>
      </div>);
    },
    ...
    renderStep0: function (authMethod) {
      return (<fieldset key={'singup-step-0'} className="animate-enter">
        ...
        <div className="col-4 col-first">
          <Peerio.UI.Tappable element='div' className="btn-lrg btn-lrg-back" onTap={this.handlePreviousStep}><i
    ...
    renderStep1: function () {
      return ( <fieldset key={'singup-step-1'}>
        ...
        <Peerio.UI.Tappable element='div' className="btn-subtle" onTap={this.generatePassphrase}> I don't like this
          passphrase</Peerio.UI.Tappable>
    ...
    renderStep3: function () {
      return (  <fieldset key={'singup-step-3'}>
        ...
        <p> Instead of entering your passphrase each time you login, you can set a shorter passcode for this device.
