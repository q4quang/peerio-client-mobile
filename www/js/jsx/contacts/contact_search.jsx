...
Peerio.UI.AddContactSearch = React.createClass({
  ...
  render: function() {
    ...
    if (searchResults === false){
      ...
      resultNode =  <Peerio.UI.ContactRequestTemplate username={this.state.searchResults.username} onTap={this.selectUserToAdd} id={this.state.searchResults.id} key={this.state.searchResults.id} />;
     ...
     resultNode = <p>Sorry, there were no results matching your search. Try searching for contacts again by their email, username or phone number.</p> ;
    }
    ...
    return (
        <div className="content-padded">
          ...
          <input type="search" className="text-input-primary" placeholder="email/username/phone" ref="searchInput"/>
