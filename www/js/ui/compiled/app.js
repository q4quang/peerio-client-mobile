(function () {
  ...
  Peerio.UI.App = React.createClass({displayName: "App",
    //--- CONSTANTS
    ...
    componentWillMount: function () {
      ...
      // pre-creating tabs
      this.tabs = [React.createElement(Peerio.UI.Messages, null), React.createElement(Peerio.UI.Files, null), React.createElement(Peerio.UI.Contacts, null)];
    },
    ...
    render: function () {
      ...
      switch (this.state.currentView) {
        case this.views.login:
          return React.createElement(Peerio.UI.LoginScreen, null);
        case this.views.tabs:
          content = this.tabs[this.state.selectedTab];
          break;
        case this.views.newMessage:
          content = React.createElement(Peerio.UI.NewMessage, null);
          break;
      }

      var tabBar = this.state.tabBarVisible ? React.createElement(Peerio.UI.TabBar, {tab: this.state.selectedTab}) : null;
      //rendering root elements
      return (
        React.createElement(Peerio.UI.Swiper, {id: "app-container", key: "app-container", onSwipeLeft: this.handleSwipe.bind(this, 'left'), 
                          onSwipeRight: this.handleSwipe.bind(this, 'right')}, 
          React.createElement(Peerio.UI.NavBar, null), 
          tabBar, 
          React.createElement(Peerio.UI.SideBar, null), 
          content, 
          React.createElement(Peerio.UI.Footer, null), 
          React.createElement(Peerio.UI.FileSelect, null)
        )
      );
